...
function iniciarMemoria() {
    ...
    function tratarClique(e) {
        ...
        // Pegar coordenadas do clique relativas ao canvas
        const rect = canvas.getBoundingClientRect();
        
        // 1. Descobre a proporção entre o tamanho interno do jogo (900x500) e o tamanho real na tela
        const escalaX = canvas.width / rect.width;
        const escalaY = canvas.height / rect.height;

        // 2. Aplica a escala para o clique funcionar milimetricamente em qualquer tela
        ...
        cartas.forEach(carta => {
            ...
            // Verificar se o clique foi dentro da carta
    ...
    window.limparEventosMemoria = () => {
        canvas.removeEventListener("click", tratarClique);
    };
}