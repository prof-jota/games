    ...
    setTimeout(() => {
        try {
            switch(idJogo) {
                ...
                case "pacman": if (typeof iniciarPacman === "function") iniciarPacman(); break;
...
function fecharJogoAnterior() {
    ...
    if (typeof pacmanInterval !== "undefined" && pacmanInterval) { clearInterval(pacmanInterval); pacmanInterval = null; }
if (typeof window.limparEventosPacman === "function") window.limparEventosPacman();
